# AlphaStar - Mastering the RTS game StarCraft II
A look into how the AlphaStar works, with some different examples from game to game, and recreate the idea into a mimic replica.
## Overview
